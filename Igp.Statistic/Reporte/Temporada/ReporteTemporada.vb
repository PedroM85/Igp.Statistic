...
Public Class ReporteTemporada
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Igp.Statistic.ReporteTemporada.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReporteTemporada
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReporteTemporada = New ReporteTemporada()
        rpt.Site = Me.Site
        Return rpt
    End Function
