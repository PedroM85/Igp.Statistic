...
Partial Public Class frmCircuito
    ...
    Private oCircuitoLayer As CircuitoDataLayer

    Dim dsCircuito As New DataSet
    Public Sub New()
        ...
        'oCircuitoLayer = New CircuitoLayer


    End Sub
    Public WriteOnly Property CircuitoLayer() As CircuitoDataLayer
        Set(ByVal Value As CircuitoDataLayer)
            oCircuitoLayer = Value
        End Set
    End Property
