...
#Region " Variables "
    ...
    Private sGroupId As String
    ' Private nLanguageId As Integer
    Private nMenuId As Integer
    Private oUserMenu As UserMenu
    Private bEnabled As Boolean
    Private bExpired As Boolean
    Private lCanAccessEwave As Boolean
    Private lCanAccessEboc As Boolean
    Private lCanAccessEcom As Boolean
    Private oSecLevel As SecurityLevel
    Private mPasswordExpired As Boolean '[AMI210405]
...
#Region " Properties "
    ...
    Public Property CanAccessEcom() As Boolean
        Get
            Return lCanAccessEcom
        End Get
        Set(ByVal Value As Boolean)
            lCanAccessEcom = Value
        End Set
    End Property

    Public Property CanAccessEwave() As Boolean
        Get
            Return lCanAccessEwave
        End Get
        Set(ByVal Value As Boolean)
            lCanAccessEwave = Value
        End Set
    End Property

    Public Property CanAccessEboc() As Boolean
        Get
            Return lCanAccessEboc
        End Get
        Set(ByVal Value As Boolean)
            lCanAccessEboc = Value
        End Set
    End Property
    ...
    '[AMI250405] Aquí almaceno la clave en md5
